"use client"
import { ArrowRight, Film, Ticket, Shield, Zap, Gift, MessageCircle } from 'lucide-react'
          ...
          <div className="flex items-center space-x-4">
            <nav>
              <ul className="flex space-x-4">
                ...
                <li><a href="#get-started" className="hover:text-orange-400">Get Started</a></li>
              </ul>
            </nav>
            <Button
              variant="outline"
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <BackgroundBeamsWithCollision>
          <section className="text-center mb-16">
            <h2 className="text-5xl font-extrabold mb-4">Revolutionizing Movie Ticketing with Blockchain</h2>
            <p className="text-xl mb-8">Secure, transparent, and innovative ticketing experience powered by blockchain technology</p>
            <a href="#get-started" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-black bg-orange-500 hover:bg-orange-600">
              Get Started
