  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow:
            "0 0 24px rgba(255, 165, 0, 0.6), 0 1px 1px rgba(255, 140, 0, 0.5), 0 0 0 1px rgba(255, 69, 0, 0.4), 0 0 4px rgba(255, 165, 0, 0.8), 0 16px 68px rgba(255, 69, 0, 0.5), 0 1px 0 rgba(255, 140, 0, 0.1) inset",
        }}
      ></div>
    </div>
  );
